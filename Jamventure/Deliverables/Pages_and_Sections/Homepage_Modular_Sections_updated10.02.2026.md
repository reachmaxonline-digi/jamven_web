...
<section class="relative min-h-screen flex items-center justify-center bg-slate-900 overflow-hidden pt-20">
    <!-- Background (Pinned to all corners for full coverage) -->
    <div class="absolute inset-0 z-0 animate-fade-in w-full h-full pointer-events-none">
        <img src="https://jamventure.tours/wp-content/uploads/2026/02/jamventure-tours-jamaica-waterfall-adventure.jpg.png" 
             alt="Jamaica Waterfall Adventure" 
...
<section id="transport-services" class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="https://jamventure.tours/private-airport-transfers-in-jamaica/" class="group block bg-slate-50 rounded-2xl overflow-hidden border border-slate-200 hover:border-green-500/30 transition-all duration-300 hover:-translate-y-1 shadow-sm hover:shadow-xl">
                <!-- Card Image -->
                <div class="relative h-48 overflow-hidden">
                    <img src="https://jamventure.tours/wp-content/uploads/2026/01/JamVenture-Private-Airport-Transfers-in-Jamaica.png" alt="Private Airport Transfers" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-slate-900/40 to-transparent"></div>
                </div>
                <!-- Card Content -->
                <div class="p-8">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-green-600 to-green-500 flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300 -mt-14 relative z-10 border-4 border-slate-50">
                    ...
                    <div class="inline-flex items-center text-green-600 font-bold hover:text-green-700 transition-colors text-sm group/link">
            ...
            <!-- Card 2: Cruise Ship Transfers -->
            <a href="https://jamventure.tours/cruise-ship-transfers-in-jamaica/" class="group block bg-slate-50 rounded-2xl overflow-hidden border border-slate-200 hover:border-yellow-400/30 transition-all duration-300 hover:-translate-y-1 shadow-sm hover:shadow-xl">
                <!-- Card Image -->
                <div class="relative h-48 overflow-hidden">
                    <img src="https://jamventure.tours/wp-content/uploads/2026/02/JamVenture-Private-Cruise-Port-Transfers-in-Jamaica.png" alt="Cruise Ship Transfers" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-slate-900/40 to-transparent"></div>
                </div>
                <!-- Card Content -->
                <div class="p-8">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300 -mt-14 relative z-10 border-4 border-slate-50">
            ...
            <!-- Card 3: Private Taxi & Hotel Transfers -->
            <a href="https://jamventure.tours/jamaica-private-taxi-service/" class="group block bg-slate-50 rounded-2xl overflow-hidden border border-slate-200 hover:border-green-500/30 transition-all duration-300 hover:-translate-y-1 shadow-sm hover:shadow-xl">
                <!-- Card Image -->
                <div class="relative h-48 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Private Taxi & Hotel Transfers</h3>
                    <p class="text-slate-600 text-sm leading-relaxed mb-6">Seamless transfers to resorts and villas across the island with comfortable, air-conditioned vehicles.</p>
                    <div class="flex flex-wrap gap-2 mb-6">
